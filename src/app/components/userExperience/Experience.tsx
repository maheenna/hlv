    ...
    return (
        <div className='pt-[5rem] pb-[3rem]'>
            ...
            Empowering Users Through  <br /> 
                <span className='text-blue-500' >Seamless Experiences </span>
            </h1>
            {/* cards */}

            <div className='w-[70%] md:w-[80%] mt-[2rem] md:mt-[3rem] mb-[3rem] mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem]'>
                {/* 1st card */}
                <div>
                    <div className='p-6 hover:bg-white/40 rounded-lg transition-all'>
                        <Image src={person1} alt='Person' className='rounded-3xl' />
                        <h1 className='mt-[1.5rem] font-semibold text-white text-center text-[24px]'>John Doe</h1>
                        <p className='text-center text-white mt-[0.2rem]'>
                ...
                {/* 2nd card */}
                <div>
                    <div className='p-6 hover:bg-white/40 rounded-lg transition-all lg:translate-y-[3rem]'>
                        <Image src={person2} alt='Burger' className='rounded-3xl' />
                        <h1 className='mt-[1.5rem] font-semibold text-white text-center text-[24px]'>Kohn Doe</h1>
                        <p className='text-center text-white  mt-[0.2rem]'>
                ...
                <div>
                    <div className='p-6 hover:bg-white/40 rounded-lg transition-all'>
                        ...
                        <h1 className='mt-[1.5rem] font-semibold text-white text-center text-[24px]'>Franklin</h1>
                        <p className='text-center text-white mt-[0.2rem]'>
