...
const BurgerCards = ({ title, image, price,  }: Props) => {
  ...
  return (
    <div className='bg-white/40 p-6 rounded-lg m-3'>
      ...
      <p className='text-black text-opacity-90 mt-[0.5rem] text-center'>Excellent product! High quality and fast delivery exceeded my expectations. Thank</p>
