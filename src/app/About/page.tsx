...
const About = () => {
    return (
        <div>
            <div className='md:pt-[3rem] md:pb-[3rem] pt-[3rem] pb-[2rem] bg-cyan-400'>
                <h1 className='heading'>
                    About <span className='text-blue-500'>HLV</span>
                </h1>
                {/* cards */}
                ...
                <div className='w-[65%] md:w-[80%] mt-[3rem] md:mt-[5rem] mb-[3rem] mx-auto grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
                    {/* 1st card */}
                    <div>
                        <div className='p-6 0 rounded-lg transition-all shadow-md bg-cyan-100'>
                    ...
                    {/* 2nd card */}
                    <div>
                        <div className='p-6  shadow-md rounded-lg transition-all  bg-cyan-100'>
                ...
                <div className='w-[65%] md:w-[80%] mt-[3rem] md:mt-[5rem] mb-[3rem] mx-auto grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
                    {/* 1st card */}
                    <div>
                        <div className='p-6   rounded-lg transition-all shadow-md  bg-cyan-100 '>
