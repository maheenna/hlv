...
const Faq = () => {
  ...
  return (
    <div className='pt-[1rem]  bg-cyan-400'>
      
      
      <h1 className='text-left md:ml-16 ml-6 md:text-[50px] font-bold text-[40px] text-white'>FQA</h1>
      <Slider/>
      <div className='bg-white/50'>
      <div className='md:mx-[6rem] md:w-[80%] w-[65%] pt-[4rem] mx-[3rem]'>
        <div className='flex items-center  space-x-2 0'>

            <FaStar className='h-[1.2rem] w-[1.2rem] sm:w-[1.4rem] sm:h-[1.4rem] text-blue-500' />
